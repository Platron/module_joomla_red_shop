...
class plgRedshop_paymentrs_payment_platron extends JPlugin
{
	 ...
	 */
	public function plgRedshop_paymentrs_payment_platron(&$subject)
	{
		// Load plugin parameters
		parent::__construct($subject);
		$this->_table_prefix = '#__redshop_';
		$this->_plugin = JPluginHelper::getPlugin('redshop_payment', 'rs_payment_platron');
	...
	public function onNotifyPaymentrs_payment_platron($element, $arrRequest)
	{
		...
		$quickpay_parameters = $this->getparameters('rs_payment_platron');
